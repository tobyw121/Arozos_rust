...
func SystemSettingInit() {
	...
	moduleHandler.RegisterModule(module.ModuleInfo{
		Name:        "System Setting",
		Desc:        "Native AlpNAS control center for system, storage and users",
	...
	return []settingGroup{
		{
			...
			Desc:     "Status, updates and runtime information for this AlpNAS node",
		},
		{
			Name:     "Devices & IoT",
			Group:    "Device",
		...
		},
		{
			...
			Desc:     "Manage AlpNAS pools, mounted media and local disks",
		},
		{
			Name:     "Network & Services",
			Group:    "Network",
			IconPath: "SystemAO/system_setting/img/network.svg",
			Desc:     "Manage host networking and service connectivity",
		},
		{
			Name:     "Users & Groups",
			Group:    "Users",
		...
		},
		{
			...
			Desc:     "Advanced AlpNAS administration and debugging",
		},
		{
			Name:     "About AlpNAS",
			Group:    "About",
			IconPath: "SystemAO/system_setting/img/info.svg",
			Desc:     "Information about the current AlpNAS desktop runtime",
		},
	}
}
