...
func main() {
	...
	if *show_version {
		fmt.Println("AlpNAS Desktop " + build_version + " Revision " + internal_version)
	...
	log.Println("AlpNAS Desktop(C) " + strconv.Itoa(time.Now().Year()) + " " + deviceVendor + ".")
	log.Println("AlpNAS Desktop " + build_version + " Revision " + internal_version)
